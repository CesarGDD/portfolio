        ...
        <div className="portfolio" >
            ...
            <div className="portfolio__cards">
                ...
                <Card 
                    ...
                    tools={`${lg? 'Technologies used:': 'Tecnologias usadas:'}  / React / Redux Toolkit / Css / API"`}
            ...
            <div className="portfolio__cards">
                <Card 
                        title='STREMEEN APP' 
                        description={lg?'STREMEEN at the reach of your hand. Please ensure to download Expo.io app in the APP Store or Play Store before scan the QR code to run the app.':'STREMEEN al alcance de tu dedo. Asegurate de descargar Expo.io de la App Store o de la Play Store antes de escanear el codigo QR para abrir la aplicacion'} 
